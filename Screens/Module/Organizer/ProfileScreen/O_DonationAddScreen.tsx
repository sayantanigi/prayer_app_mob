...
export default function O_PodcastAddScreen() {
  ...
  const SuccessAlert = async () => {
    ...
    formData.append("d_image", mainFile);

    formData.append("d_title", form.d_title);
    formData.append("d_amount", form.d_amount);
    formData.append("d_description", form.d_description);
    setLoading(true);
    let response = await fetch(BASE_URL + "add_donation", {
      method: "POST",
      body: formData,
      headers: {
  ...
  return (
    ...
    >
      <View style={styles.Container}>
        ...
        <View style={styles.InputBlock}>
          ...
          <View style={styles.Input}>
            <TextInput
              ...
              onChangeText={(text) => handleValueChange(text, "d_title")}
        ...
        <View style={styles.InputBlock}>
          <Text style={styles.Heading}>Donation Amount</Text>
          <View style={styles.Input}>
            <TextInput
              style={styles.InputField}
              onChangeText={(text) => handleValueChange(text, "d_amount")}
        ...
        <View style={styles.InputBlock}>
          ...
          <View style={[styles.Input, styles.CommentInput]}>
            <TextInput
              ...
              onChangeText={(text) => handleValueChange(text, "d_description")}
            ></TextInput>
            <Image
