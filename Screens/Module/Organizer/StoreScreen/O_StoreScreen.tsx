...
import U_ScreenLayout from "../O_ScreenLayout";
...
export default function O_StoreScreen() {
  ...
  return (
    <O_ScreenLayout
      ...
      title="Store"
      onCheckOutButtonPress={pressbutton}
      onAddToCartPress={pressbutton}
    >
      {/* Search Bar */}
      ...
      <View style={styles.DataBlock}>
        ...
        getBannerList.length > 0 ? (
          ...
          <Text>No data...</Text> // Or any other placeholder content
        )}
      </View>
