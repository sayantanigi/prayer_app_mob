          ...
          <View style={styles.ArtistTopSection}>
            <View style={styles.ArtistData}>
              <Text style={styles.ArtistText}>
                12.5K Listeners . 40 Episodes
              </Text>
              {shouldFollow ? (
                <>
                  <Pressable
                    style={styles.ArtistFollowBtn}
                    onPress={() => {
                ...
                <Pressable
                  style={styles.ArtistActiveFollowBtn}
                  onPress={() => setShouldFollow(!shouldFollow)}
                >
          ...
          <View style={styles.ModalBody}>
            ...
            <View style={styles.ModalBtnContainer}>
              {modallikeVisible ? (
                <>
                  <Pressable
                    style={styles.ModalLikeActiveBtn}
                    onPress={() => {
                      setModalLikeVisible(!modallikeVisible);
                    }}
                  >
                    <Image
