...
export default function O_PodcastScreen() {
  ...
  function onCheckOutButtonPress() {}
  function onTocartPress() {}
  return (
    <O_ScreenLayout
      BannerHidden
      HeaderHidden
    ...
    >
      ...
      <View style={styles.DataBlock}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("O_LikePodcastScreen")}
        >
          <Image
      ...
      <View style={styles.DataBlock}>
        <Pressable
          ...
          onPress={() => navigation.navigate("O_PodcastListScreen")}
        >
          {/* <Image
